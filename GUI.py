...
class Window:
    def __init__(self):
        ...
        # Setup window
        self.window = tk.Tk()
        self.window.geometry("500x150+800+300")
    ...
    def PasswordEntry(self, Sender, password):
        ...
        try:
            ...
            statusLabel = tk.Label(self.titleFrame, text="Login Failed, Connection Error", fg="red")
    ...
    def defineNewPatronInfo(self):
        ...
        if self.CourseYN.get() == 0:
            CourseYN = "N"
        else:
            CourseYN = "Y"
        if self.research.get() == 0:
            research = "N"
        else:
            research = "Y"
        if self.OwnC.get() == 0:
