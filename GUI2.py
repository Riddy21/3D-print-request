...
class Window():
    ...
    def StartMenu(self):
        ...
        tk.Button(self.titleFrame, text="Ready For Pickup", width="40", pady="5",
                  command=lambda: self.getInfo(self.readyForPickup, "Send Email")).pack()
        tk.Button(self.titleFrame, text="Delay Printing", width="40", pady="5",
                  command=lambda: self.getInfo(self.DelayedPrinting, "Send Email")).pack()
